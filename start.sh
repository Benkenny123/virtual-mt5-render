...
# Check if Deriv MetaTrader 5 is already installed
if [ -e "$deriv_marker" ]; then
    show_message "[2/7] Deriv MetaTrader 5 is already installed."
else
    show_message "[2/7] File $mt5file is not installed. Installing Deriv MT5..."

    # Set Windows 10 mode in Wine and install the bundled Deriv MT5 setup
    $wine_executable reg add "HKEY_CURRENT_USER\\Software\\Wine" /v Version /t REG_SZ /d "win10" /f
    show_message "[3/7] Installing Deriv MetaTrader 5..."
